...
import { Button, Input, FormLabel, FormControl } from '@material-ui/core';
                ...
                <div className="card">
                    <div className="card-block">
                        ...
                        <div className="row">
                            ...
                            <div className="col-6">
                                <button onClick={this.saveServiceConfig}  disabled={this.state.modelChangesSubmitted} color="default" className="btn btn-default float-right">OK</button>
                            </div>
                        </div>
